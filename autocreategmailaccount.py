...
# @Last Modified by:   Gerrit Anders
...
class CreateGmail:
    ...
    def __init__(self, firstname, lastname, username, pswd):
        ...
        self._pswd = pswd
        self._Donefile = open("./CreatedAccounts.csv", "a")
        self.Initialize()
    ...
    def SetRecoveryEmail(self):
        CreatedEmails = pd.read_csv("./CreatedAccounts.csv")["username"].values
...
if __name__ == "__main__":
    ...
    firstnamefile = "./CSV_Database_of_First_Names.csv"
    lastnamefile = "./CSV_Database_of_Last_Names.csv"
